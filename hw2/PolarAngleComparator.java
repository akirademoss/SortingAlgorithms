...
public class PolarAngleComparator implements Comparator<Point>
{
	...
	public int compare(Point p1, Point p2)
	{
		...
		else if ((p1.equals(referencePoint)) || (p1 != referencePoint && p2 != referencePoint) 
				&& (comparePolarAngle(p1, p2) == -1)|| (p1 != referencePoint && p2 != referencePoint) 
    ...
    {
    	if(dotProduct(p1,p2) == dotProduct(p2,p2))
    	{
    		return 0;
    	}
    	if(dotProduct(p2,p2) > dotProduct(p1,p1))
    	{
    		return -1;
    	}
    	return 1;
    ...
    {
		int value = 0;
		value = ((p1.getX() - referencePoint.getX()) * (p2.getY() - referencePoint.getY()))
    ...
    {
		int value = 0;
		value = ((p1.getX() - referencePoint.getX()) * (p2.getX() - referencePoint.getX())
				+ ((p1.getY() - referencePoint.getY()) * (p2.getY() - referencePoint.getX())));
		return value;
    }
}
